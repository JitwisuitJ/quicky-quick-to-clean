...
export const metadata = {
  ...
  description:
    'ร้านล้างรถไดร์ฟทรู ล้างภายนอก สะอาด รวดเร็ว คนในเมืองถูกใจสิ่งนี้ เวลาที่เร่งรีบแล้วต้องใช้รถไปทำธุระ ถ้าต้องไปรอล้างนานๆไม่สะดวก มาล้างที่ Quicky รถจะสะอาดภายในเวลา 5 นาที แถมไม่ต้องลงจากรถ แวะล้างได้สะดวกสุดๆ แนะนำเลยจ้า ดี ราคาก็ดี',
};
  ...
  return (
    <html lang='en'>
      <Head>
        <meta
          name='description'
          content='ร้านล้างรถไดร์ฟทรู ล้างภายนอก สะอาด รวดเร็ว คนในเมืองถูกใจสิ่งนี้ เวลาที่เร่งรีบแล้วต้องใช้รถไปทำธุระ ถ้าต้องไปรอล้างนานๆไม่สะดวก มาล้างที่ Quicky รถจะสะอาดภายในเวลา 5 นาที แถมไม่ต้องลงจากรถ แวะล้างได้สะดวกสุดๆ แนะนำเลยจ้า ดี ราคาก็ดี'
        />
        <meta
          name='keywords'
